  ...
  parameters = [
    {
      name: "text",
      type: "string",
      // Замер 08.08.2026: владелец продиктовал поздравление, модель «улучшила»
      // формулировки и озвучила свой вариант. Человек диктует текст, когда
      // хочет услышать именно его — переписывание тут не помощь, а подмена.
      description:
        "Текст, который Ава озвучивает в видео-кружочке. " +
        "ВАЖНО: если пользователь продиктовал текст — передавай его ДОСЛОВНО, слово в слово, " +
        "не переписывай, не украшай и не сокращай. Сочиняй сам только если текста не дали.",
      required: true,
    },
  ];
